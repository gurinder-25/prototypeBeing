...
export const Home = ({ onOpenGuides }: HomeProps) => {
  const { user } = useAuth();
          ...
          <div className="w-full max-w-2xl mx-auto fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="glass-morphism rounded-[2.5rem] p-8 relative overflow-hidden">
              ...
              <div className="flex items-center gap-2 mb-6">
                <span className="text-sm tracking-[0.2em] text-zinc-500 uppercase">Daily Wisdom</span>
              </div>
              ...
              <div className={`quote-transition ${isChanging ? 'quote-fade-out' : ''}`}>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-base text-zinc-500 font-medium">— {currentQuote.author}</p>
                </div>
              </div>
            </div>
          </div>
